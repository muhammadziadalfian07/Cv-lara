    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-body">
                ...
                <form role="form" method="post" action="{{ url('admin/manage-pengalaman/'.$dt->id) }}">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jabatan" class="form-control" id="exampleInputPassword1" placeholder="" value="{{ $dt->jabatan }}">
                        </div>
                        <div class="form-group">
